...
const TerbaikSection = () => {
    return (
        <section className="min-h-svh bg-white rounded-3x px-16 max-md:p-8 mx-auto flex flex-col items-center justify-center gap-8">
            ...
            <div className='flex flex-col gap-8 md:border rounded-3xl w-full h-full justify-center items-center md:py-16 py-16 px-8 border border-slate-300'>
                <div className='flex flex-col gap-2 items-center text-center max-md:px-8'>
                    ...
                    <div className='bg-primary-gradient bg-clip-text lg:w-1/2'>
                ...
                <div className='max-w-screen-lg w-full flex flex-col gap-4 rounded-2xl p-4'>
                    <TerbaikCarousel />
                </div>
            </div>
        </section>
